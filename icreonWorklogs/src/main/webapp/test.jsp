...
<div class="col-sm-4">
<label for="" class="thick"><b>From Date (YYYY-MM-DD)</b><span style="color:red;"></span></label>
<input class="form-control" type="text"  autocomplete="off" name="FromDate" placeholder="Enter From Date" required="" id="FromDate" />
</div>

<div class="col-sm-4">
<label for="" class="thick"><b>To Date (YYYY-MM-DD)</b><span style="color:red;"></span></label>
<input class="form-control" type="text" autocomplete="off" name="ToDate" placeholder="Enter To Date" required="" id="ToDate" />
</div>
